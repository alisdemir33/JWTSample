    ...
    public class MyTokenHandler
    {
      //  public IConfiguration Configuration { get; set; }
        ...
        public Token CreateAccessToken()
        {
            ...
            tokenInstance.Expiration = DateTime.Now.AddMinutes(_appSettings.TokenExpirationTimeInMinutes);
            ...
            tokenInstance.RefreshTokenExpirationDate= DateTime.Now.AddMinutes(_appSettings.RefreshTokenExpirationTimeInMinutes);
